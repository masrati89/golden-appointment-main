...
serve(async (req) => {
  ...
  // H-5: Require Authorization header. Accept the service_role key (DB webhooks / cron)
  // or a valid user JWT (frontend invocations).
  ...
  // Only validate as user JWT if it is not the service_role key itself.
